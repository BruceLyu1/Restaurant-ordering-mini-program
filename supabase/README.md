...
4. Apply `seed.sql` once to create the demo restaurant, tables, staff, menu items, and settings.
5. Migrate read-only services first: restaurant settings, printer settings, tables, and menu.
6. Migrate order creation and status updates after read paths are stable.
7. Add Realtime subscriptions for orders first, then menu/table/settings changes.
8. Add Supabase Auth and tighten RLS before a public multi-restaurant pilot.
